                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('/download-invoice/'.$order->id)}}" class="btn btn-primary btn-xs" title="Download Invoice">
                                            ...
                                            <a href="{{url('/delete-category/'.$order->id)}}" class="btn btn-success  btn-xs"  title="Edit Category">
                                                <span class="glyphicon glyphicon-edit"></span>
                                            </a>
                                        <a href="{{url('/delete-category/'.$order->id)}}" class="btn btn-danger btn-xs" onclick="return confirm('are you sure to remove this??')" title="Delete Category">
