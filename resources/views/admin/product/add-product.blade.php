                    ...
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" action="{{url('/new-product')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-3 control-label">Brand Name</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="product_quantity" class="form-control" id="inputEmail3" placeholder="Product Quantity">
